...
class DeviceSerializer(Serializer):
    ...
    def validate_id(self, value):
        ...
        if not id.isdigit() or id == tmp_value:
            raise serializers.ValidationError( "id field must be in this format: /devices/id<pk>" )
    ...
    def validate_deviceModel(self, value):
        ...
        if not device_model.isdigit():
            raise serializers.ValidationError("deviceModel field must be in this format /devicemodels/id1")
